...
const UserRetention = () => {
	return (
		...
		>
			<h2 className='text-xl font-semibold text-gray-100 mb-4'>Total Requests</h2>
			<div style={{ width: "100%", height: 300 }}>
				<ResponsiveContainer>
					<LineChart data={userRetentionData}>
						...
						<Tooltip
							contentStyle={{
								backgroundColor: "rgba(3, 148, 9)",
								borderColor: "#4B5563",
							}}
							itemStyle={{ color: "#E5E7EB" }}
						/>
						<Legend />
						<Line type='monotone' dataKey='retention' stroke='green' strokeWidth={2} />
					</LineChart>
				</ResponsiveContainer>
			</div>
		</motion.div>
